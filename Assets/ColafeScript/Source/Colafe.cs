////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>                                                                                                        ///
/// Main file containing Colafe class + IColafeCallable + GenericValue class.                                        ///
/// </summary>                                                                                                       ///
/// <remarks>                                                                                                        ///
/// Inherit Colafe lets you to run code + store local variables in your class                                        ///
/// Implement IColafeCallable so that Colafe can call methods from your class                                        ///
/// You can access the classes in this file with <c>using ColafeScript;</c>                                          ///
/// </remarks>                                                                                                       ///
/// <note>                                                                                                           ///
...
{
    /// <summary>
    /// Implement this to be able to call functions from the interpreter.
    /// </summary>
    public interface IColafeCallable{
        /// <summary>
        /// This method gets called with the name of the function to call + an array of arguments.
        /// Write a switch with the functionName, then in each case just call the function with the same name.
        /// return null if the functions is not found. return Colafe.VOID if your function returns null.
        /// </summary>
        /// <param name="functionName">The name of the function that is being called.</param>
        /// <param name="args">An array of generic arguments to be used in the function calls.</param>
        /// <returns>Null if the function is not found, the return value of the function if it is found.</returns>
        GenericValue CallFunction(string functionName, GenericValue[] args);
    }
    
    /// <summary>
    /// A generic value, use the properties or the implicit conversions.
    ...
    /// Inherit this if you want your own interpreter instance inside your component.
    /// </summary>
